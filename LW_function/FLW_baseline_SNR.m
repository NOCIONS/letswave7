classdef FLW_baseline_SNR<CLW_generic
    ...
    methods
        function obj = FLW_baseline_SNR(tabgp)
            obj@CLW_generic(tabgp,'SNR','bl_snr',...
            ...
            uicontrol('style','text','position',[35,520,350,20],...
            ...
            obj.h_xstart_edt=uicontrol('style','edit','String','2',...
                'position',[35,490,110,30],'parent',obj.h_tab);
            uicontrol('style','text','position',[160,495,10,20],'string','-',...
                'HorizontalAlignment','left','parent',obj.h_tab);
            obj.h_xend_edt=uicontrol('style','edit','String','5',...
                'position',[180,490,110,30],'parent',obj.h_tab);
            
            uicontrol('style','text','position',[35,420,350,20],...
                'string','number of extreme bins (min and max) to remove:',...
                'HorizontalAlignment','left','parent',obj.h_tab);
            obj.h_num_extreme_edt=uicontrol('style','edit','String','0',...
                'position',[35,390,110,30],'parent',obj.h_tab);
            
            uicontrol('style','text','position',[35,320,350,20],...
                'string','Operation:',...
                'HorizontalAlignment','left','parent',obj.h_tab);
            obj.h_operation_pop=uicontrol('style','popupmenu',...
                'String',{'subtract','SNR','zscore','phase percent'},'value',1,...
                'position',[35,290,200,30],'parent',obj.h_tab);
        end
