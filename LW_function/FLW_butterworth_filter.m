classdef FLW_butterworth_filter<CLW_generic
    ...
    methods
        function obj = FLW_butterworth_filter(tabgp)
            obj@CLW_generic(tabgp,'butt filter','butt',...
            ...
            obj.h_filtertype_pop=uicontrol('style','popupmenu',...
                ...
                'position',[35,490,300,30],'parent',obj.h_tab);
            ...
            obj.h_high_cutoff_txt=uicontrol('style','text','position',[15,420,150,19],...
                'string','high cutoff frequency(Hz):','HorizontalAlignment','right',...
                'parent',obj.h_tab);
            obj.h_high_cutoff_edt=uicontrol('style','edit',...
                'String','30','position',[180,420,100,19],'parent',obj.h_tab);
            
            obj.h_filter_order_txt=uicontrol('style','text','position',[15,390,150,19],...
                'string','filter order:','HorizontalAlignment','right',...
                'parent',obj.h_tab);
            obj.h_filter_order_edt=uicontrol('style','edit',...
                'String','4','position',[180,390,100,19],'parent',obj.h_tab);
