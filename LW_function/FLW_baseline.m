classdef FLW_baseline<CLW_generic
    ...
    methods
        function obj = FLW_baseline(tabgp)
            obj@CLW_generic(tabgp,'baseline','bl',...
            ...
            obj.h_operation_pop=uicontrol('style','popupmenu','String',...
                ...
                'position',[35,490,350,30],'parent',obj.h_tab);
            ...
            uicontrol('style','text','position',[160,395,10,20],'string','-',...
                'HorizontalAlignment','left','parent',obj.h_tab);
            obj.h_xend_edt=uicontrol('style','edit','String','',...
                'position',[180,390,110,30],'parent',obj.h_tab);
            obj.h_rest_btn=uicontrol('style','pushbutton','String','reset',...
                'position',[320,390,60,30],'Callback',@obj.reset_Callback,...
                'parent',obj.h_tab);
        end
