classdef FLW_load<CLW_generic
    ...
    methods
        function obj = FLW_load(tabgp)
            obj@CLW_generic(tabgp,'load',' ','Load the letswave data files.');
