classdef FLW_import_mat
    ...
    methods
        ...
        function obj=init_handles(obj)
            obj.h_fig=figure('Position',[100 50 600 510],'name','Import mat variable','NumberTitle','off');
            set(obj.h_fig,'MenuBar','none');
            set(obj.h_fig,'DockControls','off');
            uicontrol('style','text','string','Select workspace variable(s) to import:','HorizontalAlignment','left',...
                'Fontsize',14,'position',[10,470,380,28]);
            obj.h_var_list=uicontrol('style','listbox','string','','HorizontalAlignment','left',...
                'Fontsize',14,'position',[15,10,250,460],'value',[],'max',10);
            obj.h_refresh_btn=uicontrol('style','pushbutton','string','Refresh','HorizontalAlignment','left',...
                'Fontsize',14,'position',[270,430,320,40]);
            obj.h_load_btn=uicontrol('style','pushbutton','string','Load mat-file into workspace','HorizontalAlignment','left',...
                'Fontsize',14,'position',[270,385,320,40]);
            icon=load('icon.mat');
            obj.h_script_btn=uicontrol('style','pushbutton',...
                'position',[550,345,40,40],'CData',icon.icon_script);
            
            uicontrol('style','text','string','Unit:','HorizontalAlignment','left',...
                'Fontsize',14,'position',[340,307,150,40]);
            obj.h_unit_pop=uicontrol('style','popup','string', {'amplitude','power','phase','complex'},'HorizontalAlignment','left',...
                'Fontsize',14,'position',[375,310,150,40]);
            
            uicontrol('style','text','string','X Start:','HorizontalAlignment','right',...
                'Fontsize',14,'position',[280,270,50,40]);
            obj.h_xstart_edit=uicontrol('style','edit','string','0','HorizontalAlignment','left',...
                'Fontsize',14,'position',[340,289,80,30]);
            uicontrol('style','text','string','X Step:','HorizontalAlignment','right',...
                'Fontsize',14,'position',[280,234,50,40]);
            obj.h_xstep_edit=uicontrol('style','edit','string','1','HorizontalAlignment','left',...
                'Fontsize',14,'position',[340,250,80,30]);
            uicontrol('style','text','string','X Unit:','HorizontalAlignment','right',...
                'Fontsize',14,'position',[280,208,50,30]);
            obj.h_xunit_pop=uicontrol('style','popup','string', {'time','frequency'},'HorizontalAlignment','left',...
                'Fontsize',14,'position',[334,209,92,32]);
            
            uicontrol('style','text','string','Y Start:','HorizontalAlignment','right',...
                'Fontsize',14,'position',[440,270,50,40]);
            obj.h_ystart_edit=uicontrol('style','edit','string','0','HorizontalAlignment','left',...
                'Fontsize',14,'position',[500,289,80,30]);
            uicontrol('style','text','string','Y Step:','HorizontalAlignment','right',...
                'Fontsize',14,'position',[440,234,50,40]);
            obj.h_ystep_edit=uicontrol('style','edit','string','1','HorizontalAlignment','left',...
                'Fontsize',14,'position',[500,250,80,30]);
            uicontrol('style','text','string','Y Unit:','HorizontalAlignment','right',...
                'Fontsize',14,'position',[440,208,50,30]);
            obj.h_yunit_pop=uicontrol('style','popup','string', {'time','frequency'},'HorizontalAlignment','left',...
                'Fontsize',14,'position',[494,209,92,32],'value',2);
            ...
            obj.h_dimension1_pop=uicontrol('style','popup',...
                'string', {'X','Y','Channels','Epochs'},'Fontsize',14,...
            ...
            obj.h_process_btn=uicontrol('style','pushbutton','string','Import','HorizontalAlignment','left',...
                'Fontsize',14,'position',[270,10,320,60]);
            try
        ...
        function option=get_option(obj)
            ...
            if(length(var_size)<temp|| var_size(temp)<=1)
                option=[];
                uiwait(msgbox({'X must be selected in the Dimension,','And there must be more than one point in Dimension X'},'Warning','modal'));
                return;
            end
