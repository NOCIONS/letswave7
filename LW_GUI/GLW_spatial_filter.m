...
uiwait(handles.fig);
    ...
    function Init_fig()
        ...
        handles.line_component=line(handles.ax_component,1:100,randn(100,1));
        handles.line_before=line(handles.ax_result,1:100,randn(100,1));
        handles.line_after=line(handles.ax_result,1:100,randn(100,1));
        handles.line_fft=line(handles.ax_fft,1:100,randn(100,1));
