...
%% fig1_init
    function fig1_init()
        ...
        set(handles.dataset_listbox,'Callback',@GLW_my_view_UpdataFcn)
        ...
        handles.epoch_listbox=uicontrol(handles.panel_edit,'style','listbox','Callback',@GLW_my_view_UpdataFcn);
        ...
        handles.channel_listbox=uicontrol(handles.panel_edit,'style','listbox','Callback',@GLW_my_view_UpdataFcn);
        ...
        set(handles.graph_row_text,'Position',[5,152,150,20]);
        set(handles.graph_row_text,'Units','normalized');
        handles.graph_row_popup=uicontrol(handles.panel_edit,'style','popup','String',{'datasets','epochs','channels'},'Callback',{@GLW_my_view_UpdataFcn,1});
        ...
        set(handles.graph_col_text,'Position',[5,93,150,20]);
        set(handles.graph_col_text,'Units','normalized');
        handles.graph_col_popup=uicontrol(handles.panel_edit,'style','popup','String',{'datasets','epochs','channels'},'Callback',{@GLW_my_view_UpdataFcn,2});
        ...
        set(handles.graph_wave_text,'Position',[5,35,150,20]);
        set(handles.graph_wave_text,'Units','normalized');
        handles.graph_wave_popup=uicontrol(handles.panel_edit,'style','popup','String',{'datasets','epochs','channels'},'Callback',{@GLW_my_view_UpdataFcn,3});
        ...
        handles.index_popup=uicontrol(handles.panel_edit,'style','popup','Callback',@GLW_my_view_UpdataFcn);
        ...
        handles.y_edit=uicontrol(handles.panel_edit,'style','edit',...
            'String',[],'Callback',@GLW_my_view_UpdataFcn);
...
%% GLW_my_view_OpeningFcn
    function GLW_my_view_OpeningFcn()
        init_parameter();
        fig1_init();
        fig2_init();
        ...
        set(handles.fig1,'Position',pos);
        set(handles.fig1,'Visible','on');
    end

%% GLW_my_view_UpdataFcn
    function GLW_my_view_UpdataFcn(~, ~,graph_changed_idx)
