classdef FLW_concatenate_dataset<CLW_generic
    properties
        FLW_TYPE=2;
    end
    
    methods
        function obj = FLW_concatenate_dataset(batch_handle)
            obj@CLW_generic(batch_handle,'concat dataset','concat',...
    ...
    methods (Static = true)
        function header_out= get_header(lwdataset_in,option)
            header_in=lwdataset_in(1).header;
