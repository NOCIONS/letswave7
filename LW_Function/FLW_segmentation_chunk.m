    ...
    methods
        function obj = FLW_segmentation_chunk(batch_handle)
            ...
            uicontrol('style','text','position',[35,410,300,20],...
                'string','Duration of each chunk (s):','HorizontalAlignment','left',...
                'parent',obj.h_panel);
            obj.h_duration_edt=uicontrol('style','edit',...
                'String','1','backgroundcolor',[1,1,1],...
                'position',[55,385,200,25],'parent',obj.h_panel);
            
            uicontrol('style','text','position',[35,350,300,20],...
                'string','Interval between the onset of successive chunks (s):','HorizontalAlignment','left',...
                'parent',obj.h_panel);
