classdef FLW_artifact_suppress<CLW_generic
    properties
    ...
    methods
        ...
        function obj = FLW_artifact_suppress(batch_handle)
            ...
            %objects
            %X labels
            obj.h_x_label=uicontrol('style','text','position',[35,480,150,20],...
            ...
            %Y labels
            obj.h_y_label=uicontrol('style','text','position',[35,430,150,20],...
                'string','Y-dimension downsample ratio :',...
                'HorizontalAlignment','left','parent',obj.h_panel);
            %y_dsratio_edit
            obj.h_y_dsratio_edit=uicontrol('style','edit',...
                'String','','value',0,'backgroundcolor',[1,1,1],...
                'position',[35,410,100,20],'parent',obj.h_panel);
            %Z labels
            obj.h_z_label=uicontrol('style','text','position',[35,380,150,20],...
