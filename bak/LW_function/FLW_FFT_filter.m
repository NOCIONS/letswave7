classdef FLW_FFT_filter<CLW_generic
    ...
    methods
        function obj = FLW_FFT_filter(tabgp)
            obj@CLW_generic(tabgp,'FFT filter','filt_fft',...
            ...
            obj.h_filtertype_pop=uicontrol('style','popupmenu',...
                ...
                'position',[35,490,360,30],'parent',obj.h_tab);
            %%
            obj.h_low_cutoff_txt=uicontrol('style','text','position',[15,450,150,19],...
                'string','low cutoff frequency(Hz):','HorizontalAlignment','right',...
                'parent',obj.h_tab);
            obj.h_low_cutoff_edt=uicontrol('style','edit',...
                'String','0.5','position',[180,450,100,19],'parent',obj.h_tab);
            obj.h_low_width_txt=uicontrol('style','text','position',[15,420,150,19],...
                'string','width(Hz):','HorizontalAlignment','right',...
                'parent',obj.h_tab);
            obj.h_low_width_edt=uicontrol('style','edit',...
                'String','0.25','position',[180,420,100,19],'parent',obj.h_tab);
            
            obj.h_high_cutoff_txt=uicontrol('style','text','position',[15,390,150,19],...
                'string','high cutoff frequency(Hz):','HorizontalAlignment','right',...
                'parent',obj.h_tab);
            obj.h_high_cutoff_edt=uicontrol('style','edit',...
                'String','30','position',[180,390,100,19],'parent',obj.h_tab);
            obj.h_high_width_txt=uicontrol('style','text','position',[15,360,150,19],...
                'string','width(Hz):','HorizontalAlignment','right',...
                'parent',obj.h_tab);
            obj.h_high_width_edt=uicontrol('style','edit',...
                'String','1','position',[180,360,100,19],'parent',obj.h_tab);
            
           obj.h_notch_fre_txt=uicontrol('style','text','position',[15,450,150,19],...
                'string','notch frequency(Hz):','HorizontalAlignment','right',...
                'parent',obj.h_tab,'visible','off');
            obj.h_notch_fre_edt=uicontrol('style','edit',...
                'String','50','position',[180,450,100,19],'parent',obj.h_tab,'visible','off');
            obj.h_notch_width_txt=uicontrol('style','text','position',[15,420,150,19],...
                'string','notch width(Hz):','HorizontalAlignment','right',...
                'parent',obj.h_tab,'visible','off');
            obj.h_notch_width_edt=uicontrol('style','edit',...
                'String','2','position',[180,420,100,19],'parent',obj.h_tab,'visible','off');
            
            obj.h_slope_width_txt=uicontrol('style','text','position',[15,390,150,19],...
                'string','slpoe cutoff width(Hz):','HorizontalAlignment','right',...
                'parent',obj.h_tab,'visible','off');
            obj.h_slope_width_edt=uicontrol('style','edit',...
                'String','2','position',[180,390,100,19],'parent',obj.h_tab,'visible','off');
            obj.h_harmonic_num_txt=uicontrol('style','text','position',[15,360,150,19],...
                'string','number of the harmonics:','HorizontalAlignment','right',...
                'parent',obj.h_tab,'visible','off');
            obj.h_harmonic_num_edt=uicontrol('style','edit',...
                'String','2','position',[180,360,100,19],'parent',obj.h_tab,'visible','off');
